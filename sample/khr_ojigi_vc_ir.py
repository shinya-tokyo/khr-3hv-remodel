    ...
    if rcb4.checkAcknowledge() == True:  #通信が返ってきたとき
        ...
        while True:
            ...
            # if strTemp == ("暑い。"):
                ...
                subprocess.call("python /home/pi/I2C0x52-IR/IR-remocon02-commandline.py t `cat /home/pi/I2C0x52-IR/aircon_on.dat`", shell=True)
        
        
            elif strTemp == ("けして" or "エアコン消して" or "エアコン消して。" or "エアコンを消して" or "エアコンを消して。"):
                
                print("結果(エアコン切):" + strTemp)
                
                print("エアコンを消します")
                subprocess.call("python /home/pi/I2C0x52-IR/IR-remocon02-commandline.py t `cat /home/pi/I2C0x52-IR/aircon_off.dat`", shell=True)
